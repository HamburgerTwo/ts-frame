  ...
  render() {
    ...
    return (<div className={s.root} onClick={this.saveUser}>
      ...
      <div className={s.fieldset}>
        ...
        <div className={s.inputBox}>
          <div className={s.inputStyle}><input className={s.innerInput} placeholder="请输入手机号" /><button className={s.queryBtn}>获取验证码</button></div>
          <div className={s.valicodeBox}><input className={s.input} placeholder="请输入验证码" /></div>
        </div>
      </div>
      <div className={s.fieldset}>
